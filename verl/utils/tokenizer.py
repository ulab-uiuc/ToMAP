...
def set_pad_token_id(tokenizer, strict=True):
    ...
    if strict:
        if tokenizer.pad_token_id != tokenizer.eos_token_id:
            ...
            warnings.warn(f'tokenizer.pad_token_id is not equal to eos_token_id. Now set to {tokenizer.eos_token_id}')
        if tokenizer.pad_token != tokenizer.eos_token:
            tokenizer.pad_token = tokenizer.eos_token
            warnings.warn(f'tokenizer.pad_token is not equal to eos_token. Now set to {tokenizer.eos_token}')
    else:
