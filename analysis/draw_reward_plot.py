...
if __name__ == "__main__":
    ...
    # 读取CSV文件
    df = pd.read_csv('/home/ph16/TinyZero-dev/figs/train_reward.csv')  # 替换为你的CSV文件路径
    ...
    # 获取数据
    steps = df["Step"]
    tomap_data = df["debate/Qwen2.5-3B-Instruct-v10-ToMAP - itemized_rewards/debate"]
    ToMAP_lite_data = df["debate/Qwen2.5-3B-Instruct-v10-ToMAP_lite - itemized_rewards/debate"]
    base_data = df["debate/Qwen2.5-3B-Instruct-v10-base - itemized_rewards/debate"]
    ...
    # 显示图形
    plt.tight_layout()
    output_filename = "figs/debate_reward.png"
