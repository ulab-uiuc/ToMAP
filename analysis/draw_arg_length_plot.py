...
if __name__ == "__main__":
    ...
    # 读取CSV文件
    df = pd.read_csv('/home/ph16/TinyZero-dev/figs/argument_length.csv')  # 替换为你的CSV文件路径
    ...
    # 获取数据
    steps = df["Step"]
    tomap_data = df["debate/Qwen2.5-3B-Instruct-v10-ToMAP - response_length/mean_argument_length"]
    ToMAP_lite_data = df["debate/Qwen2.5-3B-Instruct-v10-ToMAP_lite - response_length/mean_argument_length"]
    base_data = df["debate/Qwen2.5-3B-Instruct-v10-base - response_length/mean_argument_length"]
    ...
    # 显示图形
    plt.tight_layout()
    output_filename = "figs/argument_length.png"
